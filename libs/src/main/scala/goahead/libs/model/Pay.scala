...
final case class PayChannel(value: String) extends StringMID
...
object PayChannel {
  ...
  implicit class RichPayChannel(val value: PayChannel) extends AnyVal {
 ...
 * 支付来源类型, 也就是支付方式
 */
final case class PaySource(value: String) extends StringMID
...
// 支付方式
final case class PayWay(value: String) extends StringMID
...
// 支付状态
final case class PayState(value: String) extends StringMID
