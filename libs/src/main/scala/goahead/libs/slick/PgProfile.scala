...
import goahead.libs.model.{ApiErrors, MID}
      ...
      new AdvancedArrayJdbcType[Json](
        ...
        s =>
          utils.SimpleArrayUtils
            ...
            .orNull,
        v => utils.SimpleArrayUtils.mkString[Json](noSpaces.pretty)(v)).to(_.toList)
      ...
      new AdvancedArrayJdbcType[T](
        ...
        s =>
          utils.SimpleArrayUtils
            ...
            .orNull,
        v => utils.SimpleArrayUtils.mkString[T](b => noSpaces.pretty(b.asJson))(v)).to(_.toSeq)
    }
